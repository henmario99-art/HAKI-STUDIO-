const CACHE='haki-studio-v2';
const LOCAL=['./','./index.html','./styles.css','./app.js','./core.js','./editor.js','./warp.js','./storage.js','./ui.js','./manifest.webmanifest','./icon.svg','./vendor/fabric.min.js'];
