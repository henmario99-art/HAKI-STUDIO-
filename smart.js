...
function createProjection(sourceObj){
  ...
  H.addMeta(projection,'projection','Proyección mockup');projection._surfaceProjection=true;
  ...
  sourceObj.excludeFromExport=true;sourceObj.opacity=.001;sourceObj.hakiName='Control del diseño';
